...
- [`character-record-template.md`](01-system-and-canon-framework/character-record-template.md) is the maintained full-fidelity template for substantial/recurring story-local characters, including namespace-qualified identity, aliases, relationship ecosystems, developed reasoning, and recovery provenance.
