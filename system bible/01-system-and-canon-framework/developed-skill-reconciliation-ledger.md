...
The repository contains 16 `.skill` archives with 100 packaged Markdown members. After duplicate package copies and repeated member paths are grouped, they represent eight skill families and 45 logical Markdown files.

Word counts below are scale signals only. They do not establish accuracy, authority, or completeness.
...
- **Fashion Empire:** `fashion-empire (2).skill` contains 20 files; `(3)` and the unsuffixed archive contain 23. The 20-file package lacks the Metis and Techne files and differs in several shared members. The two 23-file packages differ in `metis-werks.md`; neither is selected by filename.
- **Estate:** the unsuffixed and `(3)` packages have identical extracted content despite different archive hashes. `(2)` differs in `estate-master-plan.md`.
- **Gender Presentation Culture:** all three archives are byte-identical.
- **Wealth Management:** all three archives have identical extracted content; archive-byte differences do not represent content differences.
- **Change, Age, Polyamory, and Sapphic Culture:** one archive exists for each family.

## Logical file manifest and required destinations

### Change Worldbuilding Toolkit — 11 files

1. `SKILL.md`
2. `00-master-index.md`
3. `01-swap-mechanics-rules-ledger.md`
4. `02-identity-memory-continuity-tracker.md`
5. `03-social-legal-institutional-response.md`
6. `04-physiological-sensory-adaptation-log.md`
7. `digital-life-swap-mechanics.md`
8. `perceived-gender-swap-mechanics.md`
9. `reference-a-mental-trait-taxonomy.md`
...
1. `SKILL.md`
2. `athena-the-algorithm.md`
3. `cassandra-labs.md`
4. `evergreen-biofoundry.md`
5. `evergreen-gemstone-manifest.md`
6. `evergreen-hair-manifest.md`
7. `evergreen-materials-manifest.md`
8. `holdings-map.md`
9. `metis-werks.md`
10. `oam-piercing-manifest.md`
11. `oam-salon-manifest.md`
12. `oam-tattoo-manifest.md`
13. `patron-model.md`
14. `presentation-technology.md`
15. `techne.md`
16. `techne-product-ideas.md`
17. `threadbourne-apparel-manufacturing-manifest.md`
18. `threadbourne-asset-tag-manifest.md`
19. `threadbourne-aws-manifest.md`
20. `threadbourne-home-manifest.md`
21. `threadbourne-living-fabric-manifest.md`
...
1. Read every packaged Markdown member completely.
2. Compare every variant at claim level; do not choose by filename.
3. Compare those claims with all current controlling System Bible records and later direct Jim decisions.
4. Classify each claim as accepted, superseded, conflicting, unclear, non-canon idea, or story-instance state.
5. Ask Jim about every unclear or conflicting claim before disposition.
6. Write accepted content into complete substantive System Bible destinations, not this ledger.
7. Record unresolved questions in the Open Questions and Development Ledger.
