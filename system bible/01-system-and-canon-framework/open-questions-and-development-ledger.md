...
| 2 | Coven language and fourteen-member Estate household context | `The Estate.docx` is framework material; the transgender anchor, thirteen partners, and `prospective coven members` are restored literally but their complete meaning and cross-framework context are not settled | Reconcile during the Polyamory and Family discussion; ask rather than infer | Protected by PIN-008 |
