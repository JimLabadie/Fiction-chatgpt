...
4. A scene involves a symbol (jewelry, tattoo, flag, decorated object): check [Symbols & Visual Culture](symbols-and-visual-culture.md) for its real history and match the emotional register to that history — a black triangle or lavender reference carries real weight; a carabiner or U-Haul joke is lighter.
