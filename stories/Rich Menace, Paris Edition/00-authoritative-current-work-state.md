...
## Approved manuscript
- Chapter One — Software Engineer Barbie — FINAL / APPROVED.
- Chapter Two — Quality Assurance — FINAL / APPROVED at `chapters/approved/002-quality-assurance.md`.
- Chapter Two approval commit: `1fe009b49d9dace2e7f03de90c49c67a850010`.
- Chapter Two ends on Allison's U-Haul line.
- The failed Chapter Three prose draft is not approved and is not governing manuscript material.

## Current Chapter Three sources
Retrieve both before outlining or drafting:
- `chapter-three-opening-continuity.md`
- `chapter-three-development.md`

These records contain the recovered post-Chapter-Two development that was previously incompletely persisted.
...
- Allison parents: Gary Kensington and Jenny Kensington. Sister: Renee Kensington.
- Chloe parents: Steve Johnson and Dorothy “Dot” Johnson. Sister: Allison Johnson.
- The parent couples knew each other in school, liked each other, but were in different circles.
