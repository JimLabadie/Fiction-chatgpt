# A Life in Plain Sight — Character Bible

Status: ESTABLISHED BASELINE; NO COMPLETED SCENES
...
See [world-and-setting.md](world-and-setting.md) for established staff and controlling shared references. Availability does not establish presence in a scene or a relationship with Steve. Consult the full shared character records before assigning individual traits or dialogue.
...
No completed scenes. Preserve the baseline above when adding later development.

| Chapter/scene | Character | Experience | Change | Remaining uncertainty |
|---|---|---|---|---|
